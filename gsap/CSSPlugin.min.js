  ...
  _gsScope._gsDefine(
    ...
    function (a, b) {
        ...
        ca = (T.convertToPixels = function (a, c, d, e, f) {
          ...
          if ((n && (d = -d), o && (d *= 100), "lineHeight" !== c || e)) {
            if ("%" === e && -1 !== c.indexOf("border")) {
              ...
              if (
                ((m.cssText = "border:0 solid red;position:" +
                  ba(a, "position") +
                  ";line-height:0;"),
                  "%" !== e &&
                  l.appendChild &&
        ...
        ja = function (a, b) {
          ...
          var c,
            ...
            e = -1 !== a.indexOf("left")
              ...
              ? "100%"
              : d[0],
            f = -1 !== a.indexOf("top") ? "0%" : -1 !== a.indexOf("bottom")
            ? "100%"
            : d[1];
          if (d.length > 3 && !b) {
            for (
      ...
      var sa = function (a, b, c, d) {
          ...
          return k
            ? (e = b
              ...
              : function (a) {
                ...
                return (
                  (h && "none" !== a ? a.substr(0, a.indexOf(b[0])) || h : h) +
                  b.join(j) +
                  i
                );
              })
        ...
        ta = function (a) {
          return (
            (a = a.split(",")), function (b, c, d, e, f, g, h) {
              var i,
                j = (c + "").split(" ");
              for (h = {}, i = 0; 4 > i; i++) {
      ...
      (j.xs0 = ""),
        (j._next = j._prev = j.xfirst = j.data = j.plugin = j.setRatio = j.rxp =
          null),
      ...
      var Ca,
        ...
        Ia = (T.Transform = function () {
          (this.perspective = parseFloat(g.defaultTransformPerspective) || 0),
            (this.force3D = g.defaultForce3D !== !1 && Ha
        ...
        Sa = function (a, b) {
          var c,
            ...
            l = a.style;
          if (
            (Ea ? (d = ba(a, Fa, null, !0)) : a.currentStyle &&
          ...
          if (
            ...
            if (16 === f.length) {
              ...
              ((K = -m.zOrigin),
                ...
                (N = Math.atan2(B, C)),
                (m.scaleX = ((Math.sqrt(x * x + y * y + z * z) * p + 0.5) | 0) /
                  p),
                (m.scaleY = ((Math.sqrt(C * C + D * D) * p + 0.5) | 0) / p),
                (m.scaleZ = ((Math.sqrt(F * F + G * G + H * H) * p + 0.5) | 0) /
                  p),
                (x /= m.scaleX),
                (B /= m.scaleY),
                (y /= m.scaleX),
            ...
            if (
              (null != d.ox &&
                ...
                -1 !== b.indexOf("DXImageTransform.Microsoft.Matrix(")
                  ? (l.filter = b.replace(I, t)) : (l.filter = t + " " + b),
                (0 === a || 1 === a) &&
                1 === h &&
                0 === i &&
                0 === j &&
              ...
              for (
                n = d.ieOffsetX || 0,
                  ...
                  d.ieOffsetX = Math.round(
                    (q - ((0 > h ? -h : h) * q + (0 > i ? -i : i) * r)) /
                        2 + u,
                  ),
                  d.ieOffsetY = Math.round(
                    (r - ((0 > k ? -k : k) * r + (0 > j ? -j : j) * q)) /
                        2 + v,
                  ),
                  ya = 0;
                4 > ya;
                ...
                (z = ha[ya]),
                  (w = m[z]),
                  (c = -1 !== w.indexOf("px") ? parseFloat(w)
                  : ca(this.t, z, parseFloat(w), w.replace(x, "")) || 0),
                  (A = c !== d[z] ? 2 > ya ? -d.ieOffsetX : -d.ieOffsetY
                  : 2 > ya
                  ? n - d.ieOffsetX
                  : o - d.ieOffsetY),
                  (l[z] = (d[z] = Math.round(
        ...
        Va = (T.set3DTransformRatio = T.setTransformRatio = function (a) {
            ...
            return void (B || P || K
              ? ((B *= L),
                ...
                (u = ((c * y) | 0) / y +
                  ...
                  I +
                  ")"),
                K && Ca ? this.t.setAttribute("transform", "matrix(" + u)
                : (A[Ea] = (z.xPercent || z.yPercent
                  ? "translate(" +
                    z.xPercent +
                    "%," +
                    z.yPercent +
          ...
          if (
            ...
            if (!(D || C || 1 !== G || M || K)) {
              return void (A[Ea] = (z.xPercent || z.yPercent
                ? "translate(" +
                  z.xPercent +
                  "%," +
                  z.yPercent +
      ...
      (j = Ia.prototype),
        (j.x = j.y = j.z = j.skewX = j.skewY = j.rotation = j.rotationX = j
          .rotationY = j.zOrigin = j.xPercent = j.yPercent = j.xOffset = j
            .yOffset = 0),
          ...
          "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
          {
            parser: function (a, b, c, d, f, h, i) {
              ...
              var k,
                ...
                D = z.transform &&
                  ("function" == typeof z.transform ? z.transform(r, q)
                  : z.transform);
              if (
                ...
                ((k.x = 0), (k.xPercent = la(z.x, C.xPercent))),
                  ...
                  Ha &&
                  ((k.rotationX = ma(
                    "rotationX" in z ? z.rotationX : "shortRotationX" in z
              ...
              return (
                (D = "function" == typeof z.transformOrigin
                  ...
                  (Ea
                    ? ((n = !0),
                      ...
                      Ha
                        ? ((l = C.zOrigin),
                          (D = D.split(" ")),
                          (C.zOrigin = (D.length > 2 ? parseFloat(D[2]) : l) ||
                            0),
                ...
                if (
                  ...
                  if (1 === e.type) {
                    if (((d = e.l), 2 === d)) {
                      ...
                      e.t[e.p] = e.xs0 + b + e.xs1 + e.xn1 + e.xs2 + e.xn2 +
                        e.xs3;
                    } else if (4 === d) {
                      e.t[e.p] = e.xs0 +
                        b +
        ...
        (j._kill = function (b) {
          ...
          for (
            ...
            ((e = c.xfirst),
              ...
              (this._classNamePT = null)), c = this._firstPT;
            c;
          ) {
            c.plugin &&
            c.plugin !== d &&
