        ...
        (d.version = "2.1.3"),
            ...
            if (
              (b.prototype.add.call(p, e, f),
                ...
                ((j = (p.rawTime() - e._startTime) * e._timeScale),
                  (!e._duration ||
                    Math.abs(
                            Math.max(0, Math.min(e.totalDuration(), j)),
                          ) -
                          e._totalTime >
                      1e-5) &&
                  e.render(j, !1, !1)),
          ...
          (s.remove = function (b) {
            if (b instanceof a) {
              ...
              var c = (b._timeline = b.vars.useFrames
                ...
                : a._rootTimeline);
              return (
                (b._startTime = (b._paused ? b._pauseTime : c._time) -
                  (b._reversed
          ...
          (s._remove = function (a, c) {
            ...
            return (
              d
                ...
                : (this._time = this._totalTime = this._duration = this
          ...
          (s._parseTimeOrLabel = function (b, c, d, e) {
            ...
            if (e instanceof a && e.timeline === this) this.remove(e);
              ...
              for (g = e.length; --g > -1;) {
                e[g] instanceof a && e[g].timeline === this &&
                  this.remove(e[g]);
              }
            }
            if (
            ...
            if (
              ...
              if (((g = b.indexOf("=")), -1 === g)) {
                return null == this._labels[b]
                  ? d ? (this._labels[b] = f + c) : c
                  : this._labels[b] + c;
              }
              (c = parseInt(b.charAt(g - 1) + "1", 10) *
                Number(b.substr(g + 1))),
                (b = g > 1
                  ? this._parseTimeOrLabel(b.substr(0, g - 1), 0, d)
                  : f);
            }
            return Number(b) + c;
          }),
          ...
          (s.render = function (a, b, c) {
            ...
            if (a >= q - e && a >= 0) {
              (o._totalTime = o._time = q),
                ...
                (o._rawPrevTime = o._duration || !b || a || o._rawPrevTime === a
                  ? a
                  : e),
                (a = q + 1e-4);
            } else if (e > a) {
            ...
            if ((o._time !== p && o._first) || c || i || l) {
              if (
                ...
                for (
                  ...
                  if (
                    d._active || (d._startTime <= p && !d._paused && !d._gc)
                  ) {
                    if (l === d) {
