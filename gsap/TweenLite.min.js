...
!function (a, b) {
  ...
  var g,
    ...
    s = function (d, f, g, h) {
      ...
      this.check = function (j) {
        for (
          var k, m, n, o, p = f.length, q = p; --p > -1;
        ) {
        ...
        if (0 === q && g) {
          if (
            ...
            if (
              e[n] = c[n] = o, "undefined" != typeof module && module.exports
            ) {
              if (d === b) {
  ...
  var A = a.requestAnimationFrame,
    ...
    D = C();
  for (
    g = ["ms", "moz", "webkit", "o"], h = g.length; --h > -1 && !A;
  ) {
    A = a[g[h] + "RequestAnimationFrame"],
      B = a[g[h] + "CancelAnimationFrame"] ||
  ...
  u("Ticker", function (a, b) {
    ...
    z.call(i),
      ...
      setTimeout(function () {
        "auto" === m && i.frame < 5 &&
          "hidden" !== (d || {}).visibilityState && i.useRAF(!1);
      }, 1500);
  }),
  ...
  var F = function () {
    k && C() - D > 2e3 &&
      ("hidden" !== (d || {}).visibilityState || !j.lagSmoothing()) && j.wake();
  ...
  F(),
    ...
    i.restart = function (a, b) {
      return this.reversed(!1).paused(!1).totalTime(
        a ? -this._delay : 0,
        b !== !1,
        !0,
      );
    ...
    i.isActive = function () {
      ...
      return !b ||
        !this._gc && !this._paused && b.isActive() &&
          (a = b.rawTime(!0)) >= c &&
    ...
    i.eventCallback = function (a, b, c, d) {
      if ("on" === (a || "").substr(0, 2)) {
        ...
        null == b
          ? delete e[a]
          : (e[a] = b,
            e[a + "Params"] = q(c) && -1 !== c.join("").indexOf("{self}")
    ...
    i.duration = function (a) {
      return arguments.length
        ? (this._duration = this._totalDuration = a,
          this._uncache(!0),
          this._timeline.smoothChildTiming && this._time > 0 &&
          this._time < this._duration && 0 !== a &&
    ...
    i.totalTime = function (a, b, c) {
      ...
      if (this._timeline) {
        if (
          ...
          if (
            a > d && !c && (a = d),
              this._startTime = (this._paused ? this._pauseTime : e._time) -
    ...
    i.progress = i.totalProgress = function (a, b) {
      var c = this.duration();
      return arguments.length ? this.totalTime(c * a, b)
      : c ? this._time / c : this.ratio;
    },
    ...
    i.paused = function (a) {
      ...
      return a != this._paused && d &&
        (k || a || j.wake(),
          b = d.rawTime(),
          c = b - this._pauseTime,
          !a && d.smoothChildTiming &&
          (this._startTime += c, this._uncache(!1)),
          this._pauseTime = a ? b : null,
          this._paused = a,
          this._active = this.isActive(),
          !a && 0 !== c && this._initted && this.duration() &&
    ...
    i.add = i.insert = function (a, b, c, d) {
      ...
      if (
        a._startTime = Number(b || 0) + a._delay,
          a._paused && this !== a._timeline &&
          (a._pauseTime = this.rawTime() -
            (a._timeline.rawTime() - a._pauseTime)),
        ...
        d = e._next,
          ...
          (e._reversed
            ? e.render(
              (e._dirty
                ? e.totalDuration()
                : e._totalDuration) - (a - e._startTime) * e._timeScale,
              b,
              c,
            )
  ...
  var H = u("TweenLite", function (b, c, d) {
    ...
    J = function (a, b) {
      ...
      for (c in a) {
        W[c] ||
          c in b && "transform" !== c && "x" !== c && "y" !== c &&
            "width" !== c && "height" !== c && "className" !== c &&
            "border" !== c ||
          !(!T[c] || T[c] && T[c]._autoCSS) || (d[c] = a[c], delete a[c]);
      }
      a.css = d;
    };
  i = H.prototype = new E(),
    ...
    R = function (a, b, c, d, e, f, g, h, i) {
      ...
      var j,
        ...
        o = {
          ...
          pr: 0,
          c: n ? parseInt(d.charAt(0) + "1", 10) * parseFloat(d.substr(2))
          : parseFloat(d) - m || 0,
        };
      return ("number" != typeof m || "number" != typeof d && !n) &&
        (g || isNaN(m) || !n && isNaN(d) || "boolean" == typeof m ||
          "boolean" == typeof d
          ? (o.fp = g,
            j = Q(
              m,
  ...
  Z._startTime = j.time,
    ...
    E._updateRoot = H.render = function () {
      ...
      if (
        ...
        if (
          c = Z._first,
            (!c || c._paused) && H.autoSleep && !Y._first &&
  ...
  var aa = function (a, b, c) {
    ...
    ca = function (a, b, c, d, e) {
      var f, g, h, i;
      if (1 === d || d >= 4) {
        for (i = e.length, f = 0; i > f; f++) {if ((h = e[f]) !== b) {
  ...
  i._init = function () {
    ...
    if (
      this._ease = k = k
        ? k instanceof w
          ...
          : x[k] || H.defaultEase
        : H.defaultEase,
        g.easeParams instanceof Array && k.config &&
      ...
      for (
        f = this._targets.length, a = 0; f > a; a++
      ) {
        this._initProps(
          this._targets[a],
          this._propLookup[a] = {},
    ...
    i._initProps = function (b, c, d, e, f) {
      ...
      L[b._gsTweenID] && _(),
        this.vars.css ||
        b.style && b !== a && b.nodeType && T.css &&
          this.vars.autoCSS !== !1 && J(this.vars, b);
      for (g in this.vars) {
        if (l = this.vars[g], W[g]) {
          l && (l instanceof Array || l.push && q(l)) &&
            -1 !== l.join("").indexOf("{self}") &&
            (this.vars[g] = l = this._swapSelfInParams(l, this));
        } else if (
          T[g] && (j = new T[g]())._onInitTween(b, this.vars[g], this, f)
        ) {
          for (
            this._firstPT = k = {
              _next: this._firstPT,
      ...
      return e && this._kill(e, b) ? this._initProps(b, c, d, e, f)
      : this._overwrite > 1 && this._firstPT && d.length > 1 &&
    ...
    i.render = function (a, b, c) {
      var d,
        ...
        j = h._duration,
        k = h._rawPrevTime;
      if (a >= j - n && a >= 0) {h._totalTime = h._time = j,
          h.ratio = h._ease._calcEnd ? h._ease.getRatio(1) : 1,
          h._reversed ||
          (d = !0, e = "onComplete", c = c || h._timeline.autoRemoveChildren),
          0 === j && (h._initted || !h.vars.lazy || c) &&
          (h._startTime === h._timeline._duration && (a = 0),
            (0 > k || 0 >= a && a >= -n || k === n && "isPause" !== h.data) &&
            k !== a && (c = !0, k > n && (e = "onReverseComplete")),
            h._rawPrevTime = g = !b || a || k === a ? a : n);} else if (n > a) {
      ...
      if (h._time !== i || c) {
        if (!h._initted) {
          ...
          if (
            !c && h._firstPT &&
            (h.vars.lazy !== !1 && h._duration || h.vars.lazy && !h._duration)
          ) {
          ...
          h._time && !d ? h.ratio = h._ease.getRatio(h._time / j)
          : d && h._ease._calcEnd &&
    ...
    i._kill = function (a, b, c) {
      ...
      var d,
        ...
        k,
        l,
        m = c && this._time && c._startTime === this._startTime &&
          this._timeline === c._timeline,
        n = this._firstPT;
      if ((q(b) || I(b)) && "number" != typeof b[0]) {for (
          d = b.length; --d > -1;
        ) {
        ...
        if (h) {
          ...
          for (f in j) {
            ...
            (m && (g.f ? g.t[g.p](g.s) : g.t[g.p] = g.s, i = !0),
              ...
              g.pg && 0 !== g.t._overwriteProps.length || (g._prev
    ...
    i.invalidate = function () {
      ...
      var a = this._time;
      return this._firstPT = this._overwrittenProps = this._startAt = this
        ._onUpdate = null,
  ...
  if (
    i = ea.prototype,
      ...
      i._kill = function (a) {
        ...
        elsefor (b = c.length; --b > -1;)null != a[c[b]] && c.splice(b, 1);
        for (; d;) {
      ...
      ea.activate = function (a) {
        for (var b = a.length; --b > -1;) {a[b].API === ea.API &&
            (T[(new a[b]())._propName] = a[b]);}
        return !0;
      },
      t.plugin = function (a) {
